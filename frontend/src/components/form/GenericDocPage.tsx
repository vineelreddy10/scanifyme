...
import { SafeDetailField, isImageField, getImageUrl } from '../../utils/renderValue'
                ...
                <div key={field.fieldname} className="sm:col-span-1">
                  ...
                  <dd className="mt-1">
                    {isEditing ? (
                      ...
                      />
                    ) : isImageField(field.fieldtype) && getImageUrl(displayValues[field.fieldname] as string) ? (
                      <div className="mt-2">
                        <img 
                          src={getImageUrl(displayValues[field.fieldname] as string) || ''} 
                          alt={field.label}
                          className="w-48 h-48 object-contain rounded border border-gray-200"
                          onError={(e) => {
